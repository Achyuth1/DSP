...
def save_char(line_in, a, b, j):
	...
	while i<np.size(a):
		...
		cv2.imwrite('char'+str(j+1)+'_'+str(i+1)+'.png',char[y_up[0]:y_down[0]+1])
		i = i+1

img = cv2.imread('train_2.jpg',0)
img1,th = cv2.threshold(img,130,255,cv2.THRESH_BINARY_INV)
cv2.imwrite('frame_2.jpg',th)
